...
class CollectionReference {
  ...
  // Future<void> add(OQ<IAddDocumentOptions> options) async {
...
class DocumentReference {
  ...
  // Future<void> get(OQ<IGetDocumentOptions> options) async {
  ...
  // Future<void> set(OQ<ISetSingleDocumentOptions> options) async {
  ...
  // Future<void> update(OQ<IUpdateSingleDocumentOptions> options) async {
  ...
  // Future<void> remove(OQ<IRemoveSingleDocumentOptions> options) async {
...
class RealtimeListener {
  ...
  Map toJson() {
    return {'close': $close}..removeWhere((key, value) => value == null);
  }
}
...
class Query {
  ...
  // Future<void> count(OQ<ICountDocumentOptions> options) async {
...
class DatabaseCommand {
  ...
  Future<DatabaseQueryCommand> inn(List<dynamic> val) async {
...
class DatabaseQueryCommand extends DatabaseLogicCommand {
  ...
  Future<DatabaseLogicCommand> inn(List<dynamic> val) async {
    final result = await $$context$$?.callMethod('in', [val]);
...
class IGeoJSONMultiPoint {
  ...
  Array<dynamic> $coordinates = Array();
...
class IGeoJSONMultiLineString {
  ...
  Array<Array<dynamic>> $coordinates = Array();
...
class IGeoJSONMultiPolygon {
  ...
  Array<Array<Array<dynamic>>> $coordinates = Array();
...
class IWatchOptions {
  ...
  Map toJson() {
    return {'onChange': $onChange, 'onError': $onError}
      ..removeWhere((key, value) => value == null);
  }
}
